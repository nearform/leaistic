...
describe('deleteAlias', async () => {
  ...
  const ensureIndexCreation = (index) => {
    try {
      ...
      console.warn('ensureIndexDeletion', {e})
      throw e
    }
  }
  ...
  beforeEach(async () => {
    try {
      ...
      console.log('🐞 beforeEach deleteAlias', e)
    } finally {
      try {
        await es.indices.putAlias({name, index})
        await awaitRefresh()
      } catch (e) {
        console.log('🐞 beforeEach deleteAlias putAlias', e)
      }
    }
    console.log('🐭🐭🐭🐭🐭🐭🐭🐭🐭🐭🐭🐭🐭🐭🐭🐭🐭🐭🐭🐭🐭🐭🐭')
  })
  ...
  const ensureAliasDeletion = (index) => {
    try {
      ...
      console.warn('ensureAliasDeletion', {e})
      throw e
    }
  }
  ...
  afterEach(async () => {
    try {
      ...
      console.log('🐞 afterEach deleteAlias', e)
    } finally {
      try {
        await ensureAliasDeletion(name)
        await awaitRefresh()
      } catch (e) {
        console.log('🐞 afterEach deleteAlias ensureAliasDeletion', e)
      }
    }
  })
